...
export default function PaymentForm() {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col lg:flex-row items-start lg:items-center justify-center p-4 bg-[var(--bg-ppal)] gap-4 lg:gap-8 min-h-screen"
    >
      <div className="w-full max-w-6xl grid gap-6 grid-cols-1 lg:grid-cols-2 items-center">
        {/* Tarjeta */}
        ...
        {/* Formulario */}
        <div className="w-full max-w-lg p-6 rounded-2xl shadow-xl" style={{ backgroundColor: "var(--bg-sec)" }}>
          <h2 className="text-2xl font-bold mb-4 border-b pb-2 text-center" style={{ color: "var(--titles)" }}>
            Detalles de Pago 💳
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            {/* Divisa */}
            <div>
              <label className="block mb-1 text-xs font-medium" style={{ color: "var(--titles)" }}>
                Divisa
              </label>
              <select
                name="currency"
